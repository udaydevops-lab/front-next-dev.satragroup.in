...
const PatientHeader = ({ patientData, billNoInfo }: any) => {
        ...
        <div>
            <div className="!cust-t-g1 flex w-full py-1 px-3 text-sm text-blue-600 rounded-lg mb-2 bg-blue-gray-100">
                <span className="">
                    ...
                    {patientData?.healthId}{" "}{patientData?.abhaAddress ? "|" : ""}{" "}
            ...
            <div className="!cust-t-g1 flex w-full py-1 px-3 text-sm text-blue-600 rounded-lg mb-2 bg-blue-gray-100">
                <span className="capitalize">
                    {"Bill Number : "} {billNoInfo?.billNumber} |{" "}
                    {"Order Date : "} {billNoInfo?.generatedDate ? moment(billNoInfo?.generatedDate).format("YYYY-MM-DD HH:mm") : ""} |{" "}
