...
import { getRadiologyResulUpdateById, getResulUpdateById, resulStatusUpdate, updateStatusProcedureResultTamplate, updateStatusRadiologyResultTamplate } from '@/app/utilities/api-urls';
...
const ResultTamplateMasterGrid: FC<ResultTamplateMasterGridProps> = ({ sampleGridData, getgridData, setRadServiceFeilsInfo, popup, setPopup, radfeilds, setRadFeilds, setBtnType, handleEdit }) => {
    ...
    const columns: GridColDef[] = [
        ...
        {
            field: "proceduresResultTemplateName",
    ...
    const handleActive = (row: any) => {
        ...
        services
            .create(`${updateStatusProcedureResultTamplate}`, postObj, Headers)
            .then((response) => {
                getgridData()
