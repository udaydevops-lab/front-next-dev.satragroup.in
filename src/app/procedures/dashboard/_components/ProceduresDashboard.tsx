...
const ProceduresDashboard: React.FC<propsData> = ({
    dashboardSummary,
    dashboardBarData,
    appointmentCounts,
    turnAroundTimeCount
    ...
    const barChartLabels = dashboardBarData.map((item: any) => item?.deptDesc);
    ...
    const data: any = [
        ...
        { type: 'Total Orders', value: currentOrders ? currentOrders.totalProceduresDashboardCount : 0, color: "#2196f3" },
    ...
    const data1: any = [
        ...
        { type: 'Total Orders', value: previousOrders ? previousOrders.totalProceduresDashboardCount : 0, color: "#2196f3" },
    ...
    const pieData = {
        ...
        datasets: [
            {
                data: [currentOrders?.totalProceduresDashboardCount, currentOrders?.totalProceduresDashboardCount - currentOrders?.examCompletedCount, currentOrders?.examCompletedCount],
    ...
    return (
        <div className='space-y-6 p-6'>
            <div className='flex gap-4 justify-between -m-4'>
                <div className='text-[#7d7d7d] font-bold subpixel-antialiased ml-6 mt-2'>Procedures Dashboard</div>
                <div>
