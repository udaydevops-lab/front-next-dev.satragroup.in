...
import { containerTypeUpdateStatus } from '@/app/utilities/api-urls';
...
const ContainerTypeGrid: FC<ContainerTypeGridProps> = ({ sampleGridData, popup, setPopup, setPopupFeilds, popupfeilds, getSampleTypeGridData }) => {
    // Edit button function
    const handleEdit = (row: any) => {
        setPopupFeilds({
            ...popupfeilds,
            containerTypeId: row.containerTypeId,
            newsampleCode: row.containerTypecode,
            newsampleDesc: row.containerTypeDesc,
        })
    ...
    const handleActive = (row: any) => {
        console.log(row.containerTypeId)
        let Headers = getHeaderResponse()
        let id = row.containerTypeId
        ...
        services
            .create(`${containerTypeUpdateStatus}${id}/${status}`, Headers)
            .then((response) => {
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            headerName: "Container Type Code",
            width: 160,
        },
        {
            field: "containerTypeDesc",
            headerName: "Container Type Description",
            width: 200,
        },
        {
            field: "status",
        ...
        },
        {
            ...
            width: 120,
            renderCell: (params: any) => (
                <div className=' flex gap-4 items-center -mt-2 justify-end w-[80px]'>
    ...
    const getRowId = (row: any) => Math.random();
    return (
        <>
            {sampleGridData &&
                // <ReactDatagrid
...
export default ContainerTypeGrid