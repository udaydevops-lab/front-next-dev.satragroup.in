...
const ProcedurePrintLayout = (props: any) => {
    ...
    const getPatientData = async () => {
        ...
        const response: any = await services.get(`${getProceduresDetailsByOrderId}${orderId}`);
...
export default ProcedurePrintLayout;
