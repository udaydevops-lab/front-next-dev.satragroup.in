...
function ProceduresEntry(props: any) {
  const headers: any = {
  ...
  const [feilds, setFeilds] = useState<any>({
    ...
    performedByDoctor: { label: "Verified By" },
  });
    ...
    try {
      if (
        ...
        const response = await services.get(
          getServiceType +
          `?serviceCode=${props.modaloc.rowData.serviceCode}&assignPrameterType=Procedures`
        );
  ...
  const getServiceData = async () => {
    try {
      const response = await services.get(
        getResultEntry +
        `patientId=${props.modaloc.rowData.patientId}&opdEncouterId=${props.modaloc.rowData.opdEncounterId}&resultEntryType=Procedures&opdEncounterSerId=${props.modaloc.rowData.opdEncounterSerId}`
      );
      setSecondgetfeilds({
        ...secondgetfeilds,
  ...
  return (
    <>
      ...
      <div className="w-full ">
        ...
        <div className="w-full mb-3 flex flex-wrap capitalize">
        ...
        <div className="w-full flex mt-2">
          <div className="w-full flex justify-end gap-4">
            {/* <ActionButton
              ...
              handleSubmit={handelSaveProcedures}
              width="w-[120px] py-3"
              disabled={
                feilds.resultVerifedDateTime !== "" &&
                  feilds.resultVerifedDateTime !== null
...
export default roleInfoScreenData(ProceduresEntry, "Re");