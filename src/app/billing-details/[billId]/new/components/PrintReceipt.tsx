...
import { getPrintContent } from "../../_components/Utils";

export default function PrintReceipt(props:any) {
        ...
        <table style={{width:"100%",tableLayout:'fixed',textAlign:'left'}}>
          <thead >
            <tr style={{borderCollapse:"collapse"}}>
              <th >S.No.</th>
              <th style={{paddingLeft:'20px',padding:'2px'}} >Payment Type</th>
              <th style={{paddingLeft:'20px',padding:'2px'}} >Amount</th>
              {/* <th style={{paddingLeft:'20px',padding:'2px'}} >Bill Amount</th> */}
            </tr>
          </thead>
          <tbody >
            {props.tableData.map((item:any, index:number) => (
              <tr style={{borderCollapse:"collapse",paddingLeft:"5px"}} className='border-collapse border-black   text-sm ps-10' key={index}>
                <td>{index + 1}</td>
                <td style={{paddingLeft:'20px',padding:'2px'}} >{item.modeOfPayment}</td>
                <td style={{paddingLeft:'20px',padding:'2px'}} >{item.amount}</td>
