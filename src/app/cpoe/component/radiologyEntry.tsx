                ...
                <div className='w-full mb-2 p-2 border'>
                    ...
                    <div className='w-full flex gap-4'>
                        ...
                        <div className='w-2/3 mb-2'>
                            <Textarea onChange={(e: any) => setFeilds({
                                ...feilds, indication: sanitizeInput(e.target.value)
                            })} />
                        </div>
                    </div>
                    <div className='w-full flex gap-4'>
                        ...
                        <div className='w-2/3 mb-2'>
                            <Textarea onChange={(e: any) => setFeilds({
                                ...feilds, procedure_2: sanitizeInput(e.target.value)
                            })} />
                        </div>
                    </div>
                    <div className='w-full flex gap-4'>
                        ...
                        <div className='w-2/3 mb-2'>
                            <Textarea onChange={(e: any) => setFeilds({
                                ...feilds, procedure_3: sanitizeInput(e.target.value)
                            })} />
                        </div>
                    </div>
                </div>
